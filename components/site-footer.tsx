                ...
                <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
                    ...
                    <div className="flex items-center gap-2">
                        <Button asChild variant="outline" size="sm" className="gap-2">
                            <Link href="https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=perwaja@gmail.com&item_name=Support%20Forge&currency_code=USD" target="_blank" rel="noopener noreferrer">
